...
class MultiSurrogate(BayesianOptBase):
    ...
    def __init__(self, func, \
        ...
        self.bounds_lower = lower_bounds # APR
        self.bounds_upper = upper_bounds # APR
    ...
    def build_models(self, xtr, ytr, kernels):
        ...
        self.xtr = xtr
        self.ytr = ytr
        models = MultiSurrogates(xtr, ytr, kernels, self.bounds_lower, self.bounds_upper) # APR
        return models
...
class PrefMPoI(MultiSurrogate):
    ...
    def scalarise(self, x, cfunc=None, cargs=(), ckwargs={}):
        ...
        base = np.ones((1,2))*[self.ref_vector[0], self.ref_vector[1]]
        
        disp = self.displacement(yp, base) # APR added
